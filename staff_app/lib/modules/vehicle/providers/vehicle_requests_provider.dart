...
class VehicleRequestsProvider with ChangeNotifier {
  ...
  Future<void> loadRequests() async {
    ...
    try {
      _requests = await _apiService.getVehicleRequests();
    } catch (e) {
  ...
  Future<bool> createRequest(Map<String, dynamic> requestData) async {
    try {
      await _apiService.createVehicleRequest(requestData);
      await loadRequests();
      return true;
    } catch (e) {
  ...
  Future<Map<String, dynamic>> getRequest(String id) async {
    return await _apiService.getVehicleRequest(id);
  }

  Future<bool> updateRequest(String id, Map<String, dynamic> requestData) async {
    try {
      await _apiService.updateVehicleRequest(id, requestData);
      await loadRequests();
      return true;
    } catch (e) {
  ...
  Future<bool> resubmitRequest(String id) async {
    try {
      await _apiService.resubmitVehicleRequest(id);
      await loadRequests();
      return true;
    } catch (e) {
      return false;
  ...
  Future<bool> approveRequest(String id, {String? comments}) async {
    try {
      await _apiService.approveVehicleRequest(id, comments: comments);
      await loadRequests();
      return true;
    } catch (e) {
  ...
  Future<bool> rejectRequest(String id, String rejectionReason) async {
    try {
      await _apiService.rejectVehicleRequest(id, rejectionReason);
      await loadRequests();
      return true;
    } catch (e) {
  ...
  Future<bool> sendBackForCorrection(String id, String correctionNote) async {
    try {
      await _apiService.sendBackVehicleRequestForCorrection(id, correctionNote);
      await loadRequests();
      return true;
    } catch (e) {
  ...
  Future<bool> cancelRequest(String id, String cancellationReason) async {
    try {
      await _apiService.cancelVehicleRequest(id, cancellationReason);
      await loadRequests();
      return true;
    } catch (e) {
