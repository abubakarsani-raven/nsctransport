...
class AuthProvider with ChangeNotifier {
  ...
  List<String> getRoles() {
    ...
    return ['staff']; // Default to staff if neither is present
  }
  ...
  bool hasAnyRole(List<String> roles) {
    final userRoles = getRoles();
    return roles.any((role) => userRoles.contains(role));
  }

  bool isSupervisor() {
    return _user?['isSupervisor'] == true;
  }
  ...
  bool canApproveRequests() {
    return hasAnyRole(['dgs', 'ddgs', 'ad_transport', 'transport_officer', 'ict_officer', 'store_officer']) ||
           (hasRole('staff') && isSupervisor());
  }

  String? getDepartment() {
    return _user?['department'];
  }
