  ...
  static Color getStatusColor(String status) {
    switch (status.toLowerCase()) {
      ...
      case 'needs_correction':
        return warningColor; // Use warning color (orange) to indicate action needed
      default:
        return Colors.grey;
    }
  }
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      navigationBarTheme: NavigationBarThemeData(
        indicatorColor: primaryColor.withOpacity(.12),
        labelTextStyle: MaterialStateProperty.resolveWith(
          (states) => textTheme.labelLarge?.copyWith(
            color: states.contains(MaterialState.selected) ? primaryColor : neutral60,
          ),
        ),
      ),
      ...
      progressIndicatorTheme: const ProgressIndicatorThemeData(
        color: primaryColor,
        linearTrackColor: neutral20,
        circularTrackColor: neutral20,
      ),
      scrollbarTheme: ScrollbarThemeData(
        thumbColor: MaterialStateProperty.all(neutral40.withOpacity(.4)),
